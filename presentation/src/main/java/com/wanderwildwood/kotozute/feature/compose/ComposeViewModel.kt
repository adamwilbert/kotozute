...
import com.wanderwildwood.kotozute.contentproviders.MmsPartProvider
import com.wanderwildwood.kotozute.manager.BluetoothMicManager
import com.wanderwildwood.kotozute.manager.MediaRecorderManager
import com.wanderwildwood.kotozute.manager.MediaRecorderManager.AUDIO_FILE_PREFIX
import com.wanderwildwood.kotozute.manager.MediaRecorderManager.AUDIO_FILE_SUFFIX
...
import com.wanderwildwood.kotozute.common.util.ClipboardUtils
import com.wanderwildwood.kotozute.common.util.MessageDetailsFormatter
import com.wanderwildwood.kotozute.common.util.extensions.makeToast
import com.wanderwildwood.kotozute.common.widget.QkContextMenuRecyclerView
...
import com.wanderwildwood.kotozute.interactor.ActionDelayedMessage
import com.wanderwildwood.kotozute.interactor.AddScheduledMessage
import com.wanderwildwood.kotozute.interactor.DeleteMessages
import com.wanderwildwood.kotozute.interactor.MarkRead
import com.wanderwildwood.kotozute.interactor.SendExistingMessage
import com.wanderwildwood.kotozute.interactor.SaveImage
...
import com.wanderwildwood.kotozute.model.getText
...
import com.wanderwildwood.kotozute.util.ActiveSubscriptionObservable
import com.wanderwildwood.kotozute.util.FileUtils
import com.wanderwildwood.kotozute.util.PhoneNumberUtils
import com.wanderwildwood.kotozute.util.Preferences
import com.wanderwildwood.kotozute.extensions.getResourceBytes
import com.wanderwildwood.kotozute.util.Constants.Companion.DELAY_CANCELLED_CACHED_ATTACHMENTS_FILE_PREFIX
import com.wanderwildwood.kotozute.util.Constants.Companion.SAVED_MESSAGE_TEXT_FILE_PREFIX
...
class ComposeViewModel @Inject constructor(
    ...
    init {
        ...
        // set initial conversation title synchronously to prevent title flash
        threadId.takeIf { it != 0L }
            ?.let(conversationRepo::getConversation)
            ?.let { conversation -> newState { copy(conversationtitle = conversation.getTitle()) } }
                        ...
                        bluetoothMicManager = BluetoothMicManager(
                            ...
                            object : BluetoothMicManager.Callbacks {
                                ...
                                override fun onDisconnected(device: AudioDeviceInfo?) {
                                    ...
                                    if (device != null) {
                                        view.recordAudioRecord.onNext(false)
                                    }
                                }
                            }
                        )
